...
- More in-depth descriptions of the experiments can be found on the wiki: https://www.notion.so/20f279d01f1880d0898ff141247bf6e8?v=210279d01f188092b746000c37c850f7&source=copy_link
...
exp_names = [d for d in os.listdir(BASE_DIR) if os.path.isdir(os.path.join(BASE_DIR, d))]
exp_names.remove('evals')
exp_names.remove('next_speaker_pred')
...
for tab, category in zip(tabs, categories):
    ...
    with tab:
        ...
        if category in ["Completion Dataset",  "Monologue Dataset", "Alignment Dataset", "Vote Prediction"]:
            ...
            st.markdown("---")
            st.subheader("Simulation Review")

            base_path = "/playpen-ssd/smerrill/llm_decisions/simulation_results"
